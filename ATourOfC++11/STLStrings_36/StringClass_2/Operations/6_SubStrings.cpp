...
* 
* 1- The easiest one would be to use the constructor string{s, p, l}, which creates a new string from string s, from
* position p, with length l.
* 
* 2- s.substr(p,n)
*		Returns a new basic_string{&s, start=p, length=n}. If p + m exceeds N-1 (npos), the last position would be N-1.
* 
*/
#include <string>
#include <iostream>
